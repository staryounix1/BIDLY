...
from (values
  ...
  ('home-services','electrical','Electrical','Électricité','كهرباء',2),
  ('home-services','handyman','Handyman','Bricolage','أشغال يدوية',3),
  ('home-services','appliance-repair','Appliance Repair','Réparation d''électroménager','إصلاح الأجهزة',4),
  ('home-services','painting','Painting','Peinture','طلاء',5),
  ('home-services','cleaning','Cleaning','Nettoyage','تنظيف',6),
